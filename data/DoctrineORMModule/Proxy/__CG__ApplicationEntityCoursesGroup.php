 ...
 */
class CoursesGroup extends \Application\Entity\CoursesGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\CoursesGroup' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\CoursesGroup' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\CoursesGroup' . "\0" . 'courses', '' . "\0" . 'Application\\Entity\\CoursesGroup' . "\0" . 'lead');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CoursesGroup $proxy) {
