...
class Subject extends \Application\Entity\Subject implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Subject' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Subject' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Subject' . "\0" . 'icon', '' . "\0" . 'Application\\Entity\\Subject' . "\0" . 'language', '' . "\0" . 'Application\\Entity\\Subject' . "\0" . 'school', '' . "\0" . 'Application\\Entity\\Subject' . "\0" . 'courses', '' . "\0" . 'Application\\Entity\\Subject' . "\0" . 'holder', '' . "\0" . 'Application\\Entity\\Subject' . "\0" . 'skills');
        }
