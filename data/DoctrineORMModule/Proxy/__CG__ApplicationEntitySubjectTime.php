 ...
 */
class SubjectTime extends \Application\Entity\SubjectTime implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\SubjectTime' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\SubjectTime' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\SubjectTime' . "\0" . 'day', '' . "\0" . 'Application\\Entity\\SubjectTime' . "\0" . 'school', '' . "\0" . 'Application\\Entity\\SubjectTime' . "\0" . 'holder', '' . "\0" . 'Application\\Entity\\SubjectTime' . "\0" . 'start', '' . "\0" . 'Application\\Entity\\SubjectTime' . "\0" . 'end');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SubjectTime $proxy) {
